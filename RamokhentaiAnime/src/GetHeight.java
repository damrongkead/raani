                ...
                if (type.equals("tkhd")) {
                    ...
                    if (type.equals("hdlr")) {
                        ...
                        if (hdlr[8] == 0x76 && hdlr[9] == 0x69 && hdlr[10] == 0x64 && hdlr[11] == 0x65) {
                            ...
                            s = (int)readFixedPoint1616(lastTkhd, lastTkhd.length - 8)+"x"+(int)readFixedPoint1616(lastTkhd, lastTkhd.length - 4);
                           // System.exit(1);
                        }
                    } else {
                        fis.skip(size - 8);
